...
{
    public class OperationalCostControllerTest : BaseControllerTest<OperationalCostController, OperationalCostModel, OperationalCostViewModel, IOperationalCostFacade>
    {
    }
}
