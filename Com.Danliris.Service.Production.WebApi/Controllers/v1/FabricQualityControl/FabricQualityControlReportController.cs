...
namespace Com.Danliris.Service.Finishing.Printing.WebApi.Controllers.v1.FabricQualityControl
{
    ...
    [ApiVersion("1.0")]
    [Route("v{version:apiVersion}/finishing-printing/quality-control/fabrics")]
    [Authorize]
    public class FabricQualityControlReportController : BaseController<FabricQualityControlModel, FabricQualityControlViewModel, IFabricQualityControlFacade>
    {
        public FabricQualityControlReportController(IIdentityService identityService, IValidateService validateService, IFabricQualityControlFacade facade, IMapper mapper) : base(identityService, validateService, facade, mapper, "1.0.0")
        {
