...
namespace Com.Danliris.Service.Finishing.Printing.WebApi.Controllers.v1.MonitoringSpecificationMachine
{
    ...
    {
        public MonitoringSpecificationMachineController(IIdentityService identityService, IValidateService validateService, IMonitoringSpecificationMachineFacade facade, IMapper mapper, string apiVersion) : base(identityService, validateService, facade, mapper, apiVersion)
        {
        }
    }
}
