...
namespace Com.Danliris.Service.Finishing.Printing.Lib.Models.Master.LossEventRemark
{
    public class LossEventRemarkModel : StandardEntity, IValidatableObject
    {
        [MaxLength(16)]
        ...
        public int LossEventCategoryId { get; set; }
        [MaxLength(16)]
        public string LossEventCategoryCode { get; set; }
        [MaxLength(4096)]
        public string LossEventCategoryLossesCategory { get; set; }
