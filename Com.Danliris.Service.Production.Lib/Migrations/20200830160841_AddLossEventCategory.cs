...
{
    public partial class AddLossEventCategory : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "LossEventCategories",
                columns: table => new
                {
                    ...
                    LossesCategory = table.Column<string>(maxLength: 4096, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LossEventCategories", x => x.Id);
                });
        }
